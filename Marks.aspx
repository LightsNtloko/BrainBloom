<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Marks.aspx.cs" Inherits="BrainBloom.Marks" %>
                    ...
                    <div class="row gy-4">
                        <div class="col-lg-3 col-md-6">
                            <div class="stats-item d-flex align-items-center w-100 h-100">
                                ...
                                <div>
                                    <asp:Label ID="lblQuizMark" runat="server">0</asp:Label><span data-purecounter-start="0" data-purecounter-end="900" data-purecounter-duration="1" class="purecounter"></span>
                                    <p id="">Overall Marks</p>
                                </div>
                            </div>
                        </div>
                        <!-- End Stats Item -->
